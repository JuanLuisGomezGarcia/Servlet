...
import static beans.FuncionesIncidencia.incidencaID;
 ...
 * @author Atenea
 */
@WebServlet(name = "IdIncidencia", urlPatterns = {"/IdIncidencia"})
public class IdIncidencia extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String incidenciaResultado = incidencaID(idincidencia);
            //Este if genera dos opciones segun exista ya o no el usuario
            if (incidenciaResultado == "null"){out.println("<h1>Incidencia no encontrada</h1>"
            + "<form action=\"idIncidencia.html\" method=\"POST\">"
            ...
            + "<input type=\"submit\" name=\"volver\" value=\"Clik\" />"
            + "</form>");}
            else{out.println("<h1>Incidencia encontrada</h1>"
