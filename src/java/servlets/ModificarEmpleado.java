...
import static beans.FuncionesEmpleado.modificarEmpleado;
...
public class ModificarEmpleado extends HttpServlet {
    ...
    try (PrintWriter out = response.getWriter()) {
        ...
        String nuevatelefono = request.getParameter("telefono");
        String nuevoNombreCompleto = request.getParameter("nombreCompleto");
        ...
        if(claveUsuario== -1){            
            ...
            +  "<form action=\"modificarEmpleado.html\" method=\"POST\">"
            ...
            modificarEmpleado(usuario,nuevaContraseña,nuevatelefono,nuevoNombreCompleto); 
            out.println("<h1>Empleado modificado</h1>"
