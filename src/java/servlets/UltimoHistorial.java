...
import static beans.FuncionesHistorial.mostrarHistorialReciente;
 ...
 * @author Atenea
 */
@WebServlet(name = "UltimoHistorial", urlPatterns = {"/UltimoHistorial"})
public class UltimoHistorial extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            + "<input type=\"submit\" name=\"volver\" value=\"Clik\" />"
            + "</form>");}
            else{String historialResultado = mostrarHistorialReciente(usuario);
