 ...
 * @author Atenea
 */
@WebServlet(name = "IncidenciaOrigen", urlPatterns = {"/IncidenciaOrigen"})
public class IncidenciaOrigen extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            + "<input type=\"submit\" name=\"volver\" value=\"Clik\" />"
            + "</form>");}
            else{String incidenciaResultado = obtenerIncidenciaDestinoUsuario(usuario);
